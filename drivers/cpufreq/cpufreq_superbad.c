		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		this_superbad->cur_policy->max = CONFIG_MSM_CPU_FREQ_MAX;
		this_superbad->cur_policy->min = CONFIG_MSM_CPU_FREQ_MIN;
		this_superbad->cur_policy->cur = CONFIG_MSM_CPU_FREQ_MAX;
